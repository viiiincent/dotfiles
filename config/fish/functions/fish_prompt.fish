# color codes: https://raw.githubusercontent.com/sshdw/dotfiles/master/.Xresources
...
function fish_prompt --description 'Write out the prompt'
	...
	if not set -q -g __fish_classic_git_functions_defined
		...
		if not set -q __fish_classic_git_prompt_initialized
			set -qU fish_color_user; or set -U fish_color_user -o 525252
			set -qU fish_color_host; or set -U fish_color_host -o 525252
